...
CUDA_VISIBLE_DEVICES=1 python mosca_precompute.py --cfg ./profile/demo/demo_prep.yaml --ws ./demo/breakdance-flare --tap_mode=cotracker --dep_mode=uni
CUDA_VISIBLE_DEVICES=1 python mosca_reconstruct.py --cfg ./profile/demo/demo_fit.yaml --ws ./demo/breakdance-flare --tap_mode=cotracker --dep_mode=uni
