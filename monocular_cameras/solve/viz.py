...
from scene.static import RGB2SH
...
class BundleAdjastmentVizualizer:
    ...
    def __init__(
        ...
        static_track_valid_mask: np.ndarray,
        ...
        self.static_tracks_valid_mask = static_track_valid_mask
        ...
        self.viz_dir = osp.join(log_dir, "static_ba_viz")
